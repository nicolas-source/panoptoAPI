...
uniqueNonFuncRelations = parent_course_folder_df[parent_course_folder_df.duplicated(subset=["CourseName"])].drop_duplicates(subset=["CourseName"])
...
filtered_parent_course_folder_df = parent_course_folder_df[~parent_course_folder_df["CourseName"].isin(uniqueNonFuncRelations["CourseName"])]
